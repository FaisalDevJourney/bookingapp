            ...
            <div class="row g-0">
              <div class="col-lg-6">
                <div class="card-body p-md-5 mx-md-4">
                  ...
                  <div class="text-center">
                    ...
                    <h4 class="mt-1 mb-5 pb-1">Learn .IO</h4>
                  </div>
                  ...
                  <form action="{{URL('/register')}}" method="POST">
                    ...
                    <div class="form-group">
                      <label class="form-label" for="form2Example22">Student or Instructor</label>
                    ...
                    <div class="d-flex align-items-center justify-content-center pb-4">
                      <p class="mb-0 me-2">Already have an ccount?</p>
              ...
              <div class="col-lg-6 d-flex align-items-center gradient-custom-2">
                <div class=" px-3 py-4 p-md-5 mx-md-4">
                  <h4 class="mb-4">Create an account and start your learning process</h4>
